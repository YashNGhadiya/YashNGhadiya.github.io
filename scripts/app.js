...
This program is a sample app.js file with all of the required information for a well-documented code.
*/

// Function header for the main function
function main() {
    // Inline comment explaining the purpose of the function
    // Code for the main function
}

// Function header for helper function
function helperFunction() {
    // Inline comment explaining the purpose of the helper function
    // Code for the helper function
}

// Contextual variable names that make the code readable
...
(function () {
    ...
    function toggleLogin(loggedIn) {
        ...
        if (loggedIn) {
            ...
            // Add the task-list nav link
            $("#taskListLink").html(`<a class="nav-link" aria-current="page" href="/task-list"><i class="bi bi-card-checklist"></i> Task List</a>`);
        } else {
            // ... other code ...

            // Remove the task-list nav link
            $("#taskListLink").html("");
        }
    }

    function ActiveLinkCallBack1() {
        switch (router.ActiveLink) {
            case "home": return DisplayHomePage;
            // ... other cases ...
            case "register": return DisplayRegisterPage;
            case "task-list": return DisplayTaskListPage; // Add this case
            default:
    ...
    function LoadContent(): void {
        ...
        if (router.ActiveLink === "task-list" || router.ActiveLink === "contact-list") {
            AuthGuard();
        }
